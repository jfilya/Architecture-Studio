      ...
      <div className="container">
        <div className={style.footer__block}>
          <div className={style.footer__first}>
            ...
            <p className={style.footer__logo}>ARCHITAA</p>
            <div className={style.footer__line}></div>
          </div>
          <ul className={style.footer__second}>
            <li>
              <a target="_blank" href="mailto:willie.jennings@example.com" rel="noreferrer">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
            ...
            <li>
              <a target="_blank" href="tel:(603) 555-0123" rel="noreferrer">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
            ...
            <li>
              <a target="_blank" href="https://goo.gl/maps/J5kxBmaoC2rAanPk7" rel="noreferrer">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
